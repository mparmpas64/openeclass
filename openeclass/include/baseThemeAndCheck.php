...
include 'login_and_token_check.php'; 
 ...
 * @version $Id: baseThemeAndCheck.php,v 1.72 2009-11-11 10:03:07 jexi Exp $
 *
...
function lang_selections() {
	...
	$html .= '<input type=\"text\" hidden name=\"token\" value=".$_SESSION["token"]." > <input type=\"text\" hidden name=\"token\" value=".$_SESSION["token"]." > </form>';
	return $html;
}
