...
$str='INSERT INTO prof_request SET
                                profname = ?,
                                profsurname = ?,
                                profuname = ?,
                                profemail = ?,
                     ...
                     $stmt->bind_param("ssssssss",autoquote($prenom_form),autoquote($nom_form),
                     autoquote($uname),autoquote($email_form),autoquote($department),
                     autoquote($userphone),
                     autoquote($usercomment),
                     autoquote($proflang));
                     $stmt->execute();
                     $stmt->close();
