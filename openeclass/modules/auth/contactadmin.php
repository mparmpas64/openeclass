...
// baseThemeAndCheck, OTHER INCLUDES AND NAMETOOLS
...
if(!empty($userid))
{
	...
	$str= "SELECT * FROM user WHERE user_id=?";
	...
	<table width=\"99%\"><caption>$langForm</caption><tbody>";
		...
		$tool_content .= "</tbody></table><input type=\"text\" hidden name=\"token\" value=".$_SESSION["token"]." > <input type=\"text\" hidden name=\"token\" value=".$_SESSION["token"]." > </form>";
	}
