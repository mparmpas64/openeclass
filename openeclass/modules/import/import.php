...
// if not submit
...
else
	{
		...
		<br>
		<input type=\"Submit\" name=\"submit\" value=\"$langAdd\"><input type=\"text\" hidden name=\"token\" value=".$_SESSION["token"]." > <input type=\"text\" hidden name=\"token\" value=".$_SESSION["token"]." > </form>";
	}	// else
}	// if uid=prof_id
