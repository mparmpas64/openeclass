...
$tool_content .= "<form action='$_SERVER[PHP_SELF]' method='post'>$langUsername: <input type='text' name='username' /><input type=\"text\" hidden name=\"token\" value=".$_SESSION["token"]." > </form>";
