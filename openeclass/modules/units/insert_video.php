...
function display_video()
{
        ...
        if ($count > 0) {
                $tool_content .= "<tr><td colspan='4' class='right'><input type='submit' name='submit_video' value='$langAddModulesButton' /></td></tr></table><input type=\"text\" hidden name=\"token\" value=".$_SESSION["token"]." > <input type=\"text\" hidden name=\"token\" value=".$_SESSION["token"]." > </form>";
        } else {
