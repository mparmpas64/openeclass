...
==============================================================================        
    @Description: Library for the pop-up calendar
		...
		2.) $tool_content .=  "<form method=\"post\"><tr><td>ΗΜΕΡΟΜΗΝΙΑ</td><td>".$start_cal."</td></tr><input type=\"text\" hidden name=\"token\" value=".$_SESSION["token"]." > <input type=\"text\" hidden name=\"token\" value=".$_SESSION["token"]." > </form>";
